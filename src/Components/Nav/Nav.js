    ...
    <nav className="nav navbar navbar-expand-lg px-5">
      ...
      <div className="justify-content-end collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="nav__list navbar-nav">
          ...
          <li className="nav-item p-5"><a href="tel:+48509154144" className="nav__links">+48 509 154 144</a></li>
          <li className="nav-item p-3"><a className="fa" href="https://www.facebook.com/psi.fryzjer.salon"><img src={require("../../photos/Xfb.png")} className="fa" alt="fb-icon"/></a></li>
        </ul>
      </div>
    </nav>
  );
